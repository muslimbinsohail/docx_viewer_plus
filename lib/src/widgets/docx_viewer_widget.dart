...
//     // Service already has the latest HTML from the JS bridge on every edit.
//     // Optionally sync one last time from WebView:
//     final h = await _webViewKey.currentState?.getHtmlContent();
//     if (h != null && h.isNotEmpty) _service.updateHtml(h);
//     if (widget.onSave != null) return await widget.onSave!();
//     return await _service.saveDocx(outputPath: outputPath);
//   }
